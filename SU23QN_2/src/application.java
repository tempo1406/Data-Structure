...
public class application {
	...
	public static void main(String[] args) {
		BST tree = new BST();
		tree.add(new Student(4, "Thang", 2004, 6.3));
		tree.add(new Student(2, "Vy", 2004, 9.2));
		tree.add(new Student(9, "Dung", 2005, 4.2));
		tree.add(new Student(5, "Toan", 2005, 4.1));
		tree.add(new Student(1, "Trong", 2007, 6.7));
		tree.add(new Student(6, "Viet", 2003, 8.7));
		tree.add(new Student(7, "Dung", 2008, 2.3));
		tree.add(new Student(10, "Nguyen", 2004, 7.8));
		tree.add(new Student(3, "Luat", 2005, 3.4));
		tree.add(new Student(8, "Khai", 2005, 6));
